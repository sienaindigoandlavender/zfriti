...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    products: [
      { slug: 'bitter-orange-marmalade', name: 'Bitter Orange', subtitle: 'Marmalade', weight: '220g', price: '12.00', description: 'Bitter oranges grow in the streets of Marrakech. Gathered in January, cut by hand, cooked slowly with sugar and nothing else.', ingredients: 'Bitter oranges, sugar', conservation: 'Store in a cool, dry place. Refrigerate after opening.' },
